...
object RemoteCustomEmojiRegistry {
    ...
    private val lookup = RemoteCustomEmojiLookup<RemoteCustomEmoji, Identifier>()
    ...
    fun resolveTexture(textureId: String): Identifier? = lookup.resolveTexture(textureId)
    ...
    private fun presentation(asset: CustomEmojiAsset, texture: Identifier): EmotionPresentation {
    ...
    class PreparedRemoteCustomEmoji internal constructor(
        ...
        internal val texture: Identifier,
    )
}
