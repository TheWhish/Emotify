...
class EmotionPickerScreen(
    ...
    private val quickSlotButtons = ArrayList<ExtractedEmotionQuickSlotButton>()
    ...
    override fun init() {
        ...
        geometry.quickSlotBounds.forEachIndexed { index, bounds ->
            quickSlotButtons += addRenderableWidget(
                ExtractedEmotionQuickSlotButton(
                    index,
                    bounds,
    ...
    override fun removed() {
        ...
        EmotionPickerMovement.release(
            client,
            restorePhysicalState = client.level != null && client.player?.isAlive == true && client.gui.overlay() == null,
        )
        super.removed()
    }
    ...
    private fun openSettings() {
        ...
        minecraft.gui.setScreen(EmotifySettingsScreen(this))
    }
    ...
    private fun renderNotice(guiGraphics: GuiGraphicsExtractor, current: EmotionPickerNotice, nowNanos: Long) {
