...
internal object EmotionPickerTheme {
    ...
    fun renderPanel(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, width: Int, height: Int) {
    ...
    fun renderList(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, width: Int, height: Int) {
        renderRaisedBox(guiGraphics, x, y, width, height, list, listDarkEdge, listLightEdge, outline, 1)
    }

    fun renderHint(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, width: Int, height: Int, opacity: Int) {
        if (opacity <= 0) {
            return
        }
        renderRoundedFill(
    ...
    fun renderHintClose(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, size: Int, hoverEmphasis: Double, opacity: Int) {
        if (opacity <= 0 || size < 7) {
            return
        }
    ...
    fun renderUnavailableCard(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, width: Int, height: Int) {
        renderRaisedBox(
            guiGraphics,
            x,
            y,
    ...
    fun renderUnavailablePreview(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, size: Int) {
    ...
    fun renderScrollbarTrack(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, width: Int, height: Int) {
        guiGraphics.fill(x, y, x + width, y + height, scrollbarTrack)
    }

    fun renderScrollbarThumb(guiGraphics: GuiGraphicsExtractor, x: Int, y: Int, width: Int, height: Int) {
