...
internal class EmotifySettingRowButton(
    ...
    override fun extractContents(guiGraphics: GuiGraphicsExtractor, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        guiGraphics.text(font, labelText.display, x + HORIZONTAL_PADDING, textY, color, false)
        guiGraphics.text(
            font,
            valueText.display,
...
internal class EmotifyVolumeSlider(
    ...
    init {
        setTooltip(Tooltip.create(Component.translatable("screen.emotify.settings.sound_volume.description")))
        updateMessage()
    }
...
internal class EmotifyPlayerRowButton(
    ...
    fun bind(displayName: String, action: Component, ignored: Boolean) {
        ...
        setTooltip(Tooltip.create(Component.literal(displayName)))
        visible = true
        active = true
    }
