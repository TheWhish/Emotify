...
abstract class EmotifySettingsBackgroundScreen(
    ...
    final override fun extractBackground(
    ...
    final override fun mouseClicked(event: MouseButtonEvent, doubleClick: Boolean): Boolean {
        ...
        if (EmotifySettingsFocusPolicy.shouldClear(
                handled,
                event.button(),
                focused != null,
                focused is AbstractButton,
            )
        ) {
            clearFocus()
            return true
...
class EmotifySettingsScreen(
    ...
    override fun init() {
        ...
        ignoredPlayersButton = settingRow(
            ...
            minecraft.gui.setScreen(IgnoredPlayersScreen(this, draft))
        }
...
private class IgnoredPlayersScreen(
    ...
    private fun renderEmptyMessage(guiGraphics: GuiGraphicsExtractor) {
        val emptyBounds = geometry.emptyState
    ...
    private fun renderStatus(guiGraphics: GuiGraphicsExtractor) {
