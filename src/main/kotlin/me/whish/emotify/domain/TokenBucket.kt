...
class TokenBucket(
    ...
    init {
        ...
        require(capacity.toLong() <= Long.MAX_VALUE / UNITS_PER_TOKEN) { "Token bucket capacity is too large: $capacity" }
