...
class EmotionSearchBoxHintMixinContractTest : FunSpec({
    test("NeoForge removes the forced vanilla shadow from Emotify search hints") {
...
private const val MIXIN_CLASS = "/me/whish/emotify/neoforge/mixin/client/EditBoxHintMixin1218.class"
