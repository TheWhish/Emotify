...
@Suppress("unused")
class BuiltInProtocolV1GoldenTest {
    @Test
    fun `built in server hello has a stable golden digest and boundary bytes`() {
    ...
    @Test
    fun `portable server hello profile accepts the built in catalog`() {
