...
class CustomEmojiAssetExporterTest {
    @Test
    fun `static export preserves pixels name and origin in PNG metadata`() {
    ...
    @Test
    fun `animated export preserves frame order transparency and cycle timing`() {
    ...
    @Test
    fun `animated export preserves every composed pixel from an Aseprite GIF`() {
    ...
    @Test
    fun `animated export clears an opaque frame before a transparent frame`() {
