...
@Suppress("unused")
class EmotionPlayPayloadCodecTest {
    ...
    @Test
    fun `play round trips and keeps stable golden bytes`() {
    ...
    @Test
    fun `play admits the largest valid body of ninety five bytes`() {
    ...
    @Test
    fun `play rejects zero identity zero sequence and non canonical values`() {
    ...
    @Test
    fun `play rejects a trailing ninety five byte body and bounds ninety six bytes`() {
