...
@Suppress("unused")
class ConnectionWorldEpochTest {
    @Test
    fun `epoch begins positive and advances monotonically`() {
    ...
    @Test
    fun `parallel lifecycle transitions cannot lose increments`() {
        val epoch = ConnectionWorldEpoch()
        val workers = 8
    ...
    @Test
    fun `invalid initial values and overflow fail fast`() {
