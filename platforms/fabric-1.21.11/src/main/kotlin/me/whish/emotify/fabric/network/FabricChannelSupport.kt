...
object FabricChannelSupport {
    ...
    fun registerConfigurationChannels(
        ...
        channels: Collection<Identifier>,
...
internal object FabricClientboundChannelSet {
    ...
    fun register(current: Int, channels: Collection<Identifier>): Int {
        var updated = current
    ...
    fun unregister(current: Int, channels: Collection<Identifier>): Int {
        var removed = EMPTY
        for (channel in channels) {
    ...
    private fun flag(channel: Identifier): Int = when (channel) {
